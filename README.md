...
[![Logo](https://files.catbox.moe/c5s9g0.jpg)](https://www.npmjs.com/package/phantom-baileys)
...
<p align="center">
   ...
   <br><br>
   <a href="https://www.npmjs.com/package/phantom-baileys">
      <img src="https://img.shields.io/npm/v/phantom-baileys?style=for-the-badge&logo=npm"/>
   </a>
   <a href="https://www.npmjs.com/package/phantom-baileys">
      <img src="https://img.shields.io/npm/dm/phantom-baileys?style=for-the-badge&logo=npm"/>
   </a>
   <a href="https://github.com/what-sapp/Baileys">
      <img src="https://img.shields.io/github/stars/what-sapp/Baileys?style=for-the-badge&logo=github"/>
   </a>
   <a href="LICENSE">
...
# NPM
"dependencies": {
   "phantom-baileys": "latest"
}

# GitHub
"dependencies": {
   "phantom-baileys": "github:what-sapp/Baileys"
}
```
...
```bash
# NPM
npm i phantom-baileys@latest

# GitHub
npm i github:what-sapp/Baileys
```
...
```javascript
// --- ESM
import { makeWASocket } from 'phantom-baileys'

// --- CJS (tested and working on Node.js 24 ✅)
const { makeWASocket } = require('phantom-baileys')
```

### 🌐 Connect to WhatsApp (Quick Step)

```javascript
import { makeWASocket, delay, DisconnectReason, useMultiFileAuthState } from 'phantom-baileys'
...
```javascript
import { makeWASocket, makeInMemoryStore, delay, DisconnectReason, useMultiFileAuthState } from 'phantom-baileys'
import { Boom } from '@hapi/boom'
import pino from 'pino'
...
const urlA = 'https://www.npmjs.com/package/phantom-baileys'

sock.sendMessage(jid, {
   text: urlA + ' 👆🏻 Check it out!',
   linkPreview: {
      'matched-text': urlA,
      title: '🌱 phantom-baileys',
...
import { prepareWAMessageMedia } from 'phantom-baileys'

const urlB = 'https://www.npmjs.com/package/phantom-baileys#readme'
...
const groupName = 'phantom-baileys'
...
sock.sendMessage(jid, {
   ...
   product: {
      ...
      signedUrl: 'https://www.npmjs.com/package/phantom-baileys',
      title: '📦 Starseed (Premium)',
      url: 'https://www.npmjs.com/package/phantom-baileys'
   },
...
```javascript
import { tokenizeCode } from 'phantom-baileys'
...
sock.sendMessage(jid, {
   ...
   offerCode: 'phantom-baileys', // --- Optional
   offerUrl: 'https://www.npmjs.com/package/phantom-baileys', // --- Optional
...
sock.sendMessage(jid, {
   ...
   cards: [{
      ...
      offerCode: 'phantom-baileys',
      offerUrl: 'https://www.npmjs.com/package/phantom-baileys',
...
sock.sendMessage(jid, {
   ...
   externalAdReply: {
      ...
      url: 'https://www.npmjs.com/package/phantom-baileys' // --- Optional, used for WhatsApp internal thumbnail caching and direct URL
   }
}, {
   quoted: message
})
...
```javascript
import { getImageProcessingLibrary } from 'phantom-baileys'
...
```javascript
// --- Create a new one
sock.newsletterCreate('phantom-baileys', '📣 Fresh updates weekly')
...
// --- Update newsletter
sock.newsletterUpdate('1231111111111@newsletter', { name: 'phantom-baileys' })

// --- Change name
sock.newsletterUpdateName('1231111111111@newsletter', '📦 phantom-baileys')
...
const group = sock.groupCreate('phantom-baileys', ['628123456789@s.whatsapp.net'])
...
// --- Change name
sock.groupUpdateSubject(jid, '📦 phantom-baileys')
...
sock.updateMemberLabel(jid, 'phantom-baileys')
```
...
const community = await sock.communityCreate('phantom-baileys', '📣 Fresh updates weekly')
...
// --- Change name
sock.communityUpdateSubject(jid, '📦 phantom-baileys')
...
await sock.updateBusinessProfile({
   ...
   websites: ['https://www.npmjs.com/package/phantom-baileys'],
...
A fast, lightweight, and modular WhatsApp bot built with [phantom-baileys](https://www.npmjs.com/package/phantom-baileys).
Perfect for managing groups, moderating chats, and adding fun with quiz games and handy tools.

👉🏻 [what-sapp/starseed](https://github.com/what-sapp/starseed#readme)
...
This fork includes additional enhancements and modifications by [Terri](https://github.com/what-sapp)
